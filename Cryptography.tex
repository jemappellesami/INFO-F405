...
\begin{center}
    \includegraphics[width=\linewidth, page={4}]{../1-Historical-Principles.pdf}
    \includegraphics[width=\linewidth, page={5}]{../1-Historical-Principles.pdf}
\end{center}
...
\end{itemize}
\begin{center}
    \includegraphics[page=10, width=0.49\textwidth]{../1-Historical-Principles.pdf}
    \includegraphics[page=11, width=0.49\textwidth]{../1-Historical-Principles.pdf}
\end{center}
